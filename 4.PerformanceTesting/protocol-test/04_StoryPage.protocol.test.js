...
const pageDuration = new Trend('page_story_duration', true)

export default function () {
	group('04_StoryPage', function () {
		const responses = http.batch([
                  ['GET','https://bakpiaku.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js',headers],
                  ['GET','https://bakpiaku.com/story/',headers],
                  ...
                  ['GET','https://bakpiaku.com/wp-content/plugins/sassy-social-share/public/js/sassy-social-share-public.js?ver=3.3.13',headers],
                  ...
                  ['GET','https://bakpiaku.com/wp-content/uploads/2020/09/Bakpiaku-012-1090x380.jpg',headers],
