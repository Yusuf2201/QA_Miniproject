...
const pageDuration = new Trend('page_blog_duration', true)

export default function () {
	group('03_BlogPage', function () {
		const responses = http.batch([
                  ['GET','https://bakpiaku.com/blog/',headers],
                  ...
                  ['GET','https://bakpiaku.com/wp-content/uploads/2020/10/cropped-bkufavicon-32x32.png',headers],
                  ['GET','https://bakpiaku.com/wp-content/uploads/2022/06/thumbnail-1000x600.jpg',headers],
                  ['GET','https://bakpiaku.com/wp-content/uploads/2022/11/BKU-Banner-Tamansari-jpeg.webp',headers],
                  ['GET','https://bakpiaku.com/wp-content/uploads/2022/12/Bakpiamu-Jakal-02-1000x600.webp',headers],
                  ['GET','https://bakpiaku.com/wp-content/uploads/2022/12/DSC03286_LQ-1000x600.webp',headers],
